...
"role" => "Team Leader",
"bio" => "I guide and support my team members and organize tasks to lead my group in
delivering wualityy tasks...",
...
"role" => "UI/UX Designer",
"bio" => "Currently, I'm working on my studies to connect multiple applications and
...
"bio" => "I am a dedicated and hardworking student who is always willing to learn new
things...",
"github" => "https://github.com",
"image" => "Dela Torre"
],
...
"role" => "Presenter",
"bio" => "I am a responsible and adaptable team member. I enjoy learning new
things...",
...
"bio" => "I am a reliable and dedicated team member skills in basic programming and
file management...",
"github" => "https://github.com",
"image" => "Pagran"
]
...
.github-link { display: inline-block; margin-top: 15px; color: #38bdf8; text-decoration:
none; font-size: 13px;}
...
<input type="text" id="searchBar" class="search-box" placeholder="Search by name or
role...">
</div>
<div class="team-grid">
...
onerror="this.src='https://ui-avatars.com/api/?name=?&background=1e3a8a&color=fff&size=
120'">
...
<a href="<?php echo $member['github']; ?>" target="_blank"
class="github-link">Contact/Social (GitHub)</a>
</div>
<?php endforeach; ?>
</div>
<script>
